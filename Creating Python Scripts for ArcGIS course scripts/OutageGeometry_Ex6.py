...
try:
    ...
    # variables
    outageXY = r"C:\Demos\EsriTraining\PYTS\Data\OutageXY.csv"
    outConvexHull = r"C:\Demos\EsriTraining\PYTS\Data\Outages.gdb\CurrentAffectedArea"
    outputJoin = r"in_memory\outputJoin"
    serviceAreas = r"C:\Demos\EsriTraining\PYTS\Data\CountyData.gdb\ServiceAreas"
    ...
    print("something went wrong....call for help")